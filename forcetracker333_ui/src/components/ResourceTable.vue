...
<template>
        ...
        <card>
          <template slot="header">
            <div class="row justify-content-between align-items-between mx-3">
              ...
              <div>
                  <base-button class="btn btn-primary" @click="modalResources = true">Add</base-button>
              </div>
              
              <modal :show.sync="modalResources">
                <template slot="header">
  ...
  <base-input label="Quantity" type="text" placeholder="Enter Quantity" v-model="resourceToAdd.quantity"></base-input>
          ...
          <div v-if="isTableView">
            ...
            <a-table :columns="columns" :data-source="resources" :row-key="record => record.ResourceId" :pagination="pagination"
          ...
          <div v-else>
            ...
            <ResourcePictureView :resources="resources" />
          </div>
...
import ResourcePictureView from './ResourcePictureView.vue';
...
export default {
  ...
  data() {
    return {
      ...
      sortBy: 'resourceId',           // Column to sort by
  ...
  methods: {
    ...
    async onTableChange(pagination, filters, sorter) {
	  ...
	  this.$emit('get-all-resources',this.sortBy,this.sortOrder,this.pagination.current-1,this.pagination.pageSize);
    ...
    handleSearchQueryChanged() {
    	...
    	this.$root.$emit('searchQueryForResourcesChanged', this.searchQuery);
	...
	async handleAddSubmitted() {
      ...
      this.resourceToAdd.created = currentDate;
