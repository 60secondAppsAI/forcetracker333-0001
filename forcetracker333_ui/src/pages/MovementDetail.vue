						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div id="app">
								  ...
								  <base-input label="DateTime" type="text" placeholder="Enter DateTime" v-model="movementToAdd.dateTime"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Date Time</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="DateTime" type="text" placeholder="Enter DateTime" v-model="movementDetails.dateTime"></input>
																		</div>
						</td>
														</tr>
