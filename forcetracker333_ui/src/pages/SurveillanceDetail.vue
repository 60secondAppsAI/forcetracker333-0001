					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateSurveillance()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div id="app">
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Surveillances = true">Add</base-button>
								              <modal :show.sync="modal2Surveillances">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Surveillance Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="SurveillanceId" type="text" placeholder="Enter SurveillanceId" v-model="surveillanceDetails.surveillanceId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Area Monitored</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="AreaMonitored" type="text" placeholder="Enter AreaMonitored" v-model="surveillanceDetails.areaMonitored"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Start Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="surveillanceDetails.startDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">End Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="surveillanceDetails.endDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  data() {
    return {
      surveillanceToAdd: {},
      modal2Surveillances: false,
      surveillanceDetails: null,
  ...
  methods: {
    ...
    async handleAddSubmitted() {
      this.modal2Surveillances = false;
    ...
    async updateSurveillance() {

      const jsonData = JSON.stringify(this.surveillanceDetails);
      const res = await SurveillanceService.update(jsonData);
...
//        this.getAllSurveillances();
      }
    },


    async getSurveillanceDetails() {
      try {
			let response = await SurveillanceService.get(this.surveillanceId);
			this.surveillanceDetails = response.data;
        ...
        console.error('Error fetching surveillance details:', error);
      }
    },
